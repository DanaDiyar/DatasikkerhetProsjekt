...
<form method="post">
    ...
    <input type="password" name="password" id="password" required><br>
    <!-- CAPTCHA visning -->
    <label for="captcha_input">Skriv inn følgende kode: <strong><?= $_SESSION['captcha'] ?></strong></label><br>
    <input type="text" name="captcha_input" id="captcha_input" placeholder="Skriv inn koden" required><br>
